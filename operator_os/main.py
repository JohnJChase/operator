...
def main(argv: list[str] | None = None) -> None:
    ...
    ms.add_argument("--token", default=None, help="shared OPERATOR_DESKTOP_TOKEN")
    ...
    mi.add_argument("--token", default=None, help="shared OPERATOR_DESKTOP_TOKEN")
...
def run_loop(
    ...
    *,
    ...
    # Quiet pickup window after SMS double-ring (legacy key: sms_ring_timeout_ms).
    sms_ring_s = float(
        profile.raw.get("timing", {}).get(
            "sms_pickup_window_ms",
            profile.raw.get("timing", {}).get("sms_ring_timeout_ms", 30000),
        )
    ) / 1000.0
